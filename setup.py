...
setup(  # This is the name of your project. The first time you publish this
    ...
    # Denotes that our long_description is in ReStructuredText; valid values are
    ...
    # above.
    author_email="adrien.suau@cerfacs.fr",  # Optional
    ...
    classifiers=[  # Optional
        ...
        # Specify the language used in the code
        "Natural Language :: English",
        # Indicates that it is pure Python and should be OS independant
    ...
    # This field tells setuptool that all the packages will be in the src/
    # directory.
    package_dir={"": "src"},
    ...
    install_requires=["qiskit", "numpy"],  # Optional
